...
from qprac_lab.algorithms.optimization.logistics_routing_qubo import run_logistics_routing_qubo_scaffold
...
def main():
    ...
    parser.add_argument("--algorithm", choices=DEMOS.keys(), required=True)
